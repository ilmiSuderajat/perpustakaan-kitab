...
fun LoginPrompt(
        ...
        onResult = { result ->
            ...
            when (result) {
                ...
                is NativeSignInResult.Error -> {
                    Log.e("LoginScreen", "Error: ${result.message}")
                }
                else -> {
                    Log.d("LoginScreen", "Other result: $result")
                }
            }
        }
    )
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Ribuan kitab kuning digital dalam satu genggaman.",
